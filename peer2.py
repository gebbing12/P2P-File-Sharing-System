...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 22:13:49 2021
...
with open('FILE_LIST_peer2.json','r') as f:
    FILE_LIST= json.load(f)

with open('REGISTER_LIST_peer2.json','r') as f:
...
def download(chunkdict):
        ...
        with open('FILE_LIST_peer2.json','w') as f:
            json.dump(FILE_LIST,f)
        with open('REGISTER_LIST_peer2.json','w') as f:
...
if __name__ == '__main__':
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as peer_socket:
            ...
            peer_socket.bind(('127.0.0.1', 7772))
